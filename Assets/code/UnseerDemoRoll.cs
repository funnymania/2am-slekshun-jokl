...
public class UnseerDemoRoll : MonoBehaviour {
	...
	public static bool camFollows = false; 
	...
	void FixedUpdate () { 
        ...
        // pressSpace=false;logoDone=false; Uncomment for non-entrance
		...
		{	
            if (toTheWakeUp)
            {
				...
				// eyeL.SetActive(true);
                // eyeL2.SetActive(true);
                // eyeR.SetActive(true);
                // eyeR2.SetActive(true);
